...
class q1b_problem:
    ...
    def getStartState(self):
        ...
        food_position = self.startingGameState.getFood().asList()
        print(f"INI Checking Goal State: Pac-Man at {pacman_position},Food at {food_position}")
        return self.startingGameState.getPacmanPosition()

    @log_function
    def isGoalState(self, state):
        "*** YOUR CODE HERE ***"
        return self.startingGameState.hasFood(*state)
