...
class q1c_problem:
    ...
    def getStartState(self):
        ...
        food_positions = tuple(self.startingGameState.getFood().asList())
        print(f"INI Checking Goal State: Pac-Man at {pacman_position},Food at {food_positions}")
        return pacman_position, food_positions

    @log_function
    def isGoalState(self, state):
        "*** YOUR CODE HERE ***"
        pacman_position, food_positions = state
        return len(food_positions) == 0
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.startingGameState.hasWall(next_x, next_y):
                ...
                new_state = ((next_x, next_y), new_food_positions)
